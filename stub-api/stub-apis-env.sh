...
export STUB_METRIC_STORE_PORT=${STUB_METRIC_STORE_PORT-1341}
export STUB_RLPG_PORT=${STUB_RLPG_PORT-1342}
...
export METRIC_STORE_URL=http://0:${STUB_METRIC_STORE_PORT}
export REVERSE_LOG_PROXY_GATEWAY_URL=http://0:${STUB_RLPG_PORT}
