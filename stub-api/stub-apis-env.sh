...
export STUB_PROMETHEUS_PORT=${STUB_PROMETHEUS_PORT-1341}
export STUB_REVERSE_LOG_PROXY_GATEWAY_PORT=${STUB_REVERSE_LOG_PROXY_GATEWAY_PORT-1342}
...
export REVERSE_LOG_PROXY_GATEWAY_URL=http://0:${STUB_REVERSE_LOG_PROXY_GATEWAY_PORT}
