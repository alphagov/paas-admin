...
var svgElem = document.getElementById('sankey');
...
var nodes = _sankey.nodes;
var links = _sankey.links;
...
var format = function format(d) { return "\xA3" + f(d); };

var govukColours = [
  '#28a197', '#912b88', '#f499be',
  '#2b8cc4', '#ffbf47', '#d53880',
  '#85994b', '#b58840', '#006435',
  '#6f72af', '#005ea5', '#df3034',
  '#b10e1e', '#2e358b', '#f47738'
];
var color = d3.scaleOrdinal(govukColours);
...
var gradient = link.append('linearGradient')
  .attr('id', function (d) { return d.uid = DOM.uid('link'); })
