// These are the 3.1 openid-client definitions. We currently have v2 installed
// which doesn't have it's types defined so we've copied and modified v3 types.
// We can't use 3.1 as it uses features/syntax of node that don't appear in any LTS.
declare module 'openid-client' {
    ...
    export class Client {
        ...
        authorizationCallback(redirectUri: string, parameters: {}, checks?: {}): Promise<TokenSet>;
    }
