...
export interface IOrganizationUserRoles {
  readonly entity: {
    ...
    readonly organization_roles: readonly OrganizationUserRoles[]
...
export interface ISpaceUserRoles {
  readonly entity: {
    ...
    readonly managed_spaces_url: string
    readonly organizations_url: string
    readonly space_roles: readonly string[]
    readonly spaces_url: string
    readonly username: string
  }
  readonly metadata: IMetadata
...
export interface ISpaceSummary {
  readonly apps: readonly IApplicationSummary[]
  readonly guid: string
  readonly name: string
  readonly services: readonly IServiceSummary[]
}
...
export interface IUserSummary {
  readonly entity: {
    readonly organizations: readonly IUserSummaryOrganization[]
    readonly managed_organizations: readonly IUserSummaryOrganization[]
    readonly billing_managed_organizations: readonly IUserSummaryOrganization[]
    readonly audited_organizations: readonly IUserSummaryOrganization[]
  }
  readonly metadata: IMetadata
}
