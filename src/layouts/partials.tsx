          ...
          <a href="/" className="govuk-header__link govuk-header__link--homepage">
            <span className="govuk-header__logotype">
              <svg role="presentation" focusable="false" className="govuk-header__logotype-crown" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 132 97" height="30" width="36">
                ...
                <image src={`${assetPath}/images/govuk-logotype-crown.png`} className="govuk-header__logotype-crown-fallback-image"></image>
              </svg>
              {' '}
        ...
        <div className="govuk-header__content">
          ...
          <nav>
            <ul id="navigation" className="govuk-header__navigation " aria-label="Top Level Navigation">
              ...
              <li className="govuk-header__navigation-item">
                <a className="govuk-header__link" href="https://docs.cloud.service.gov.uk">
                  Documentation
                </a>
              </li>
              ...
              <li className="govuk-header__navigation-item">
                <a href="https://www.cloud.service.gov.uk/sign-in"
                  title="Switch region"
          ...
          <div className="govuk-footer__meta-item govuk-footer__meta-item--grow">
            ...
            <ul className="govuk-footer__inline-list">
              <li className="govuk-footer__inline-list-item">
                <a className="govuk-footer__link" href="https://www.gov.uk/government/organisations/government-digital-service">
                  Built by the Government Digital Service
                </a>
              </li>
              <li className="govuk-footer__inline-list-item">
                <a className="govuk-footer__link" href="https://www.cloud.service.gov.uk/cookies">
                  Cookies
                </a>
              </li>
            </ul>
