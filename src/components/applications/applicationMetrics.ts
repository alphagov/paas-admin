...
import applicationMetricsTemplate from './metrics.njk';
...
export async function viewApplicationMetrics(ctx: IContext, params: IParameters): Promise<IResponse> {
  ...
  return {
    body: applicationMetricsTemplate.render({
