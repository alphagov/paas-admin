  ...
  return (
    <tr className="govuk-table__row">
      <td className="govuk-table__cell">
        <a href={props.linkTo('admin.organizations.view', {organizationGUID: props.guid})} className="govuk-link">
          {props.name}
        </a>
      </td>
      <td className="govuk-table__cell">
...
export function OrganizationsPage(props: IOrganizationPageProperties): ReactElement {
  const organizations = props.organizations.map(org => (
    <Organization
      ...
      linkTo={props.linkTo}
      billable={props.quotas[org.entity.quota_definition_guid].entity.name !== 'default'}
    />
  ));
  ...
  return (<>
    ...
    <p className="govuk-body">
      ...
      {' '}
      <a href="https://www.cloud.service.gov.uk/signup" className="govuk-link">
    ...
    <div className="govuk-grid-row">
      <div className="govuk-grid-column-full">
        ...
        <p className="govuk-body">
          Installing the Cloud Foundry command line will let you operate GOV.UK PaaS
      ...
      <div className="govuk-grid-column-one-third">
        ...
        <p className="govuk-body">
          <a href="https://packages.cloudfoundry.org/stable?release=redhat64&source=github" className="govuk-link">
            Download the RedHat version
          </a>
        </p>
        <p className="govuk-body">
          <a href="https://packages.cloudfoundry.org/stable?release=debian64&source=github" className="govuk-link">
      ...
      <div className="govuk-grid-column-one-third">
        ...
        <p className="govuk-body">
          <a href="https://packages.cloudfoundry.org/stable?release=macosx64&source=github" className="govuk-link">
      ...
      <div className="govuk-grid-column-one-third">
        ...
        <p className="govuk-body">
          <a href="https://packages.cloudfoundry.org/stable?release=windows64&source=github" className="govuk-link">
    ...
    <p className="govuk-body">
      For more information about the Cloud Foundry command line tool, or to view
      the source code
      {' '}
      <a href="https://github.com/cloudfoundry/cli#downloads" className="govuk-link">
    ...
    <div className="govuk-grid-row">
      <div className="govuk-grid-column-one-half">
        <h2 className="govuk-heading-m">
          Set up and deploy your first app
        </h2>
      ...
      <div className="govuk-grid-column-one-half">
        <h2 className="govuk-heading-m">
          Learn more about orgs and spaces
        </h2>

        <p className="govuk-body">
          <a href="https://docs.cloud.service.gov.uk/orgs_spaces_users.html" className="govuk-link">
            Get familiar
          </a>
          {' '}
    ...
    <div className="govuk-grid-row">
      <div className="govuk-grid-column-one-half">
        <h2 className="govuk-heading-m">
          Get GOV.UK PaaS status updates
        </h2>

        <p className="govuk-body">
          <a href="https://status.cloud.service.gov.uk/" className="govuk-link">
            Check the status
          </a>
          {' '}
        ...
        <p className="govuk-body">
          We recommend you subscribe to this service to get alerts and incident
          updates.
        </p>
      </div>
    </div>
    ...
    <div className="govuk-grid-row">
      <div className="govuk-grid-column-one-half">
        ...
        <p className="govuk-body">
          GOV.UK PaaS supports Google single sign-on as an authentication method.
        </p>

        <p className="govuk-body">
          <a href={props.linkTo('account.use-google-sso.view')} className="govuk-link">
            Set up Google single sign-on
          </a>
        </p>
      </div>
      ...
      <div className="govuk-grid-column-one-half">
        ...
        <p className="govuk-body">
          <a href={props.linkTo('account.use-microsoft-sso.view')} className="govuk-link">
            Set up Microsoft single sign-on
          </a>
        </p>
      </div>
