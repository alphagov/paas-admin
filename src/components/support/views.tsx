...
interface ISignupFormProperties extends IFormProperties {
  readonly errors?: readonly IDualValidationError[]
          ...
          <p className='govuk-body'>
            If you have a critical issue, <a className='govuk-link' href='https://status.cloud.service.gov.uk/'>start by
              checking the system status page
                                          </a>: if it&apos;s a known issue with the platform, it will show there and
            ...
            <fieldset
              ...
              aria-describedby={
                ['invite_users-hint',
                  ...
                  ((props.errors != null) || []).filter(e => e.field.includes('additional_users')).map(e => `${e.field}-error`)
                ).filter(x => x).join(' ')
              }
            >
              <legend className='govuk-fieldset__legend govuk-fieldset__legend--s'>
                        ...
                        <td className='govuk-table__cell'>
                          <div className='govuk-form-group'>
                            ...
                            <input
                              ...
                              type='text'
                              defaultValue={((props.values?.additional_users) != null) && props.values.additional_users[0].email}
                              aria-describedby={
                                props.errors?.some(e => e.field === 'additional_users-0')
                          ...
                          <div className='govuk-checkboxes'>
                            <div className='govuk-checkboxes__item'>
                              <input
                                ...
                                type='checkbox'
                                value='yes'
                                defaultChecked={((props.values?.additional_users) != null) && props.values.additional_users[0].person_is_manager === 'yes'}
                              />
                        ...
                        <td className='govuk-table__cell'>
                          <div className='govuk-form-group'>
                            ...
                            <input
                              ...
                              type='text'
                              defaultValue={((props.values?.additional_users) != null) && props.values.additional_users[1].email}
                              aria-describedby={
                                props.errors?.some(e => e.field === 'additional_users-1')
                          ...
                          <div className='govuk-checkboxes'>
                            <div className='govuk-checkboxes__item'>
                              <input
                                ...
                                type='checkbox'
                                value='yes'
                                defaultChecked={((props.values?.additional_users) != null) && props.values.additional_users[1].person_is_manager === 'yes'}
                              />
                        ...
                        <td className='govuk-table__cell'>
                          <div className='govuk-form-group'>
                            ...
                            <input
                              ...
                              type='text'
                              defaultValue={((props.values?.additional_users) != null) && props.values.additional_users[2].email}
                              aria-describedby={
                                props.errors?.some(e => e.field === 'additional_users-2')
                          ...
                          <div className='govuk-checkboxes'>
                            <div className='govuk-checkboxes__item'>
                              <input
                                ...
                                type='checkbox'
                                value='yes'
                                defaultChecked={((props.values?.additional_users) != null) && props.values.additional_users[2].person_is_manager === 'yes'}
                              />
    ...
    <div className='govuk-grid-row'>
      <div className='govuk-grid-column-two-thirds'>
        ...
        <ul className='govuk-list govuk-list--bullet'>
          <li>
            <a href='/downloads/govuk-paas-crown-mou.pdf' className='govuk-link' download>
  ...
  return (
    <div className='govuk-grid-row'>
      <div className='govuk-grid-column-two-thirds'>
        ...
        <ul className='govuk-list govuk-list--bullet'>
          <li>
            <a href='/downloads/govuk-paas-noncrown-mou.pdf' className='govuk-link' download>
