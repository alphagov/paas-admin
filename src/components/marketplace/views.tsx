...
export interface IPaaSServiceMetadata {
  ...
  readonly AdditionalMetadata?: {
    readonly otherDocumentation?: readonly string[]
...
export function PlanTab (props: IPlanTabProperties): ReactElement {
  ...
  const limitsMemory = props.plans.some(plan => !((plan.broker_catalog.metadata.AdditionalMetadata?.memory) == null))
  const limitsStorage = props.plans.some(plan => !((plan.broker_catalog.metadata.AdditionalMetadata?.storage) == null))
    ...
    <div className='govuk-tabs'>
      ...
      <ul className='govuk-tabs__list'>
        {props.versions.map((version, index) => (
          <Tab
            key={index} active={version === props.version} href={props.linkTo('marketplace.service', {
            ...
            <tbody className='govuk-table__body'>
              {props.plans.map((plan, index) => (
                <TableRow
                  ...
                  data={(plan.broker_catalog.metadata.AdditionalMetadata != null) || {}}
        ...
        <ul className='govuk-list marketplace-list'>
          {props.services.map((service, index) => {
            ...
            return (
              <li key={index}>
                <a
                  href={props.linkTo('marketplace.service', {
