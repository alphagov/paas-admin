...
describe('service metrics test suite', () => {
  ...
  beforeEach(() => {
    ...
    server.use(
      http.get(`${ctx.app.cloudFoundryAPI}/v2/organizations/6e1ca5aa-55f1-4110-a97f-1f3473e771b9/user_roles`, () => {
        return new HttpResponse(
          data.userRolesForOrg,
        );
      }),
      http.get(`${ctx.app.cloudFoundryAPI}/v2/service_instances/0d632575-bb06-4ea5-bb19-a451a9644d92`, () => {
        return new HttpResponse(
      ...
      http.get(`${ctx.app.cloudFoundryAPI}/v2/user_provided_service_instances/54e4c645-7d20-4271-8c27-8cc904e1e7ee`, () => {
        return new HttpResponse(
          data.userServiceInstance,
        );
      }),
      http.get(`${ctx.app.cloudFoundryAPI}/v2/services/a00cacc0-0ca6-422e-91d3-6b22bcd33450`, () => {
        return new HttpResponse(
          data.serviceString,
        );
      }),
  ...
  it('should show the service metrics page', async () => {
    server.use(
      http.post('https://aws-cloudwatch.example.com/', () => {
        return new HttpResponse(
      ...
      http.get(`${ctx.app.cloudFoundryAPI}/v2/services/a14baddf-1ccc-5299-0152-ab9s49de4422`, () => {
        return new HttpResponse(
          JSON.stringify(data.serviceObj),
        );
      }),
    );
  ...
  it('should return cloudwatch metrics for a cdn-route backing service', async () => {
    server.use(
      http.post('https://aws-tags.example.com/', () => {
        return new HttpResponse(
          getStubResourcesByTag(),
        );
      }),
      http.post('https://aws-cloudwatch.example.com/', () => {
        return new HttpResponse(
  ...
  it('should return prometheus metrics for an elasticsearch backing service', async () => {
    server.use(
      http.get('https://example.com/prom/api/v1/query_range', () => {
        return new HttpResponse(
          getStubPrometheusMetricsSeriesData(['001', '002']),
        );
      }),
      http.get(`${ctx.app.cloudFoundryAPI}/v2/services/a14baddf-1ccc-5299-0152-ab9s49de4422`, () => {
        return HttpResponse.json(
  ...
  it('should fail to download csv if no data returned from prometheus', async () => {
    server.use(
      http.get('https://example.com/prom/api/v1/query_range', () => {
        return new HttpResponse(
          getStubPrometheusMetricsSeriesData([]),
        );
      }),
      http.get(`${ctx.app.cloudFoundryAPI}/v2/services/a14baddf-1ccc-5299-0152-ab9s49de4422`, () => {
        return HttpResponse.json(
