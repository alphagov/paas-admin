...
export function ApplicationEventDetailPage(props: IApplicationEventDetailPageProperties): ReactElement {
  return (<>
...
export function ApplicationEventsPage(props: IApplicationEventsPageProperties): ReactElement {
      ...
      <tbody className="govuk-table__body">
        {props.events.map(event => (
          <EventListItem
            ...
            href={props.linkTo('admin.organizations.spaces.applications.event.view', {
              organizationGUID: props.organizationGUID,
              spaceGUID: props.spaceGUID,
              applicationGUID: props.application.metadata.guid,
