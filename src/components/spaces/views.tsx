...
export interface IEnhancedSpace extends ISpace {
  ...
  readonly running_apps: readonly IApplication[]
  readonly stopped_apps: readonly IApplication[]
  readonly serviceInstances: readonly IServiceInstance[]
}
...
interface ISpacesPageProperties {
  ...
  readonly spaces: readonly IEnhancedSpace[]
  readonly users: readonly IUser[]
}

interface IApplicationPageProperties {
  readonly applications: readonly IEnhancedApplication[]
  readonly linkTo: RouteLinker
