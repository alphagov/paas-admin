...
async function hydrateAccountsUsernames (
  userRoles: readonly IOrganizationUserRoles[],
  accountsClient: AccountsClient
): Promise<readonly IOrganizationUserRoles[]> {
  ...
  return users as readonly IOrganizationUserRoles[]
}
  ...
  return {
    body: template.render(
      <BackingServicePage
        ...
        services={[
          ...summarisedServices,
          ...((userServices as unknown) as readonly IStripedUserServices[])
        ]}
        space={space}
      />
    )
