  ...
  return (
    <div className='govuk-grid-row'>
      <form method='post' className='govuk-grid-column-one-half'>
        ...
        {(props.errors != null)
          ? <div
            className='govuk-error-summary' aria-labelledby='error-summary-title'
        ...
        <div className='govuk-form-group'>
          ...
          <input
            id='organization' name='organization' className='govuk-input' aria-describedby='organization-hint'
            type='text' defaultValue={props.values?.organization} required pattern={SLUG_REGEX}
          />
        </div>
        ...
        <div className='govuk-form-group'>
          ...
          <input
            id='owner' name='owner' className='govuk-input' aria-describedby='owner-hint' type='text'
            defaultValue={props.values?.owner} required
          />
        </div>
