...
nock('https://example.com/api')
  ...
  .get('/v2/services/a00cacc0-0ca6-422e-91d3-6b22bcd33450').times(1).reply(200, data.serviceString)
  .get('/v2/spaces/38511660-89d9-4a6e-a889-c32c7e94f139').times(2).reply(200, data.space)
  .get('/v2/organizations/6e1ca5aa-55f1-4110-a97f-1f3473e771b9').times(2).reply(200, defaultOrg())
