  ...
  return (<>
    ...
    <div className="govuk-tabs" data-module="govuk-tabs">
      ...
      <ul className="govuk-tabs__list">
        <Tab
          active={props.routePartOf('admin.organizations.spaces.services.view')}
        ...
        <Tab
          active={props.routePartOf('admin.organizations.spaces.services.metrics.view')}
          href={props.linkTo('admin.organizations.spaces.services.metrics.view', {
            organizationGUID: props.organizationGUID,
            spaceGUID: props.spaceGUID,
            serviceGUID: props.service.metadata.guid,
          })}>
        ...
        <Tab
          active={props.routePartOf('admin.organizations.spaces.services.events.view')}
      ...
      <div className="govuk-grid-row">
        <div className="govuk-grid-column-two-thirds">
          <table className="govuk-table">
            ...
            <tbody className="govuk-table__body">
              <tr className="govuk-table__row">
                ...
                <td className="govuk-table__cell name">{props.service.entity.name}</td>
              </tr>
              <tr className="govuk-table__row">
                <th scope="row" className="govuk-table__header">Type</th>
                <td className="govuk-table__cell label">
                  {props.service.service?.entity.label || 'User Provided Service'}
                </td>
              </tr>
              <tr className="govuk-table__row">
                <th scope="row" className="govuk-table__header">Plan</th>
                <td className="govuk-table__cell plan">{props.service.service_plan?.entity.name || 'N/A'}</td>
              </tr>
              <tr className="govuk-table__row">
                <th scope="row" className="govuk-table__header">State</th>
                <td className="govuk-table__cell status">{props.service.entity.last_operation?.state || 'N/A'}</td>
              </tr>
              <tr className="govuk-table__row">
                <th scope="row" className="govuk-table__header">Tags</th>
                <td className="govuk-table__cell tags">{props.service.entity.tags.join(', ')}</td>
              </tr>
            </tbody>
          </table>
          ...
          <p className="govuk-body">
            You can also view the same information on the commandline, to see details for all of your services use:
          </p>
